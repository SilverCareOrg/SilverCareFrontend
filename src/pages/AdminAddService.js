...
function AdminAddService() {
  ...
  return (
    ...
    <form onSubmit={handleAddService}>
      ...
      {formData.options_common_city && <div className="mb-4">
      ...
      {formData.options_common_city && <div className="mb-4 relative  flex flex-row">
        <label className="block font-semibold">
        ...
        <div className="mt-4 border border-2 p-4 rounded-md">
          ...
          {options.map((option, index) => (
            <div key={index} className="mb-2 p-2 border border-2 rounded-md">
              ...
              <div className="mb-2">
                <label htmlFor={`optionName${index}`} className="block font-semibold">
                  Option Name
                </label>
                <input
                  type="text"
              ...
              <div className="mb-2">
                <label htmlFor={`optionPrice${index}`} className="block font-semibold">
              ...
              <div className="mb-4">
                <label htmlFor={`optionDetails${index}`} className="block font-semibold">Details</label>
                <textarea
              ...
              <div className="mb-4">
                  <label htmlFor={`optionDateTime${index}`} className="block font-semibold">
              ...
              {!(formData.options_common_city === true && formData.common_location === true) && <div className="mb-4 relative flex flex-row">
                <label className="block font-semibold">
                  ...
                  <input
                    ...
                    onChange={() => handleOptionChange(index, "option_has_location", !option.option_has_location)}
                    className="w-5 h-4 ml-2 mr-2"
                  />
                </label>
                <div className="relative group">
              ...
              {option.option_has_location && <div className="mb-4">
                <label htmlFor={`optionMapLocation${index}`} className="block font-semibold text-[1.2rem]">Map Location<span className="text-[1rem]"> - Please select the location on the map</span></label>
                <div className="w-full h-80 border rounded-md">
                  <MapContainer
                    center={mapLocation}
                    zoom={5}
                  ...
                  >
                    <TileLayer
                      url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
                    />
                    <Marker position={optionMarkerPositions[index] || [44.43, 26.09]} icon={markerIcon}>
                      <Popup>Selected Location</Popup>
                    </Marker>

                    <MapEventsHandler handleMarkerClick={(e) => handleOptionMarkerClick(e, index)} />
                  </MapContainer>
                </div>
              </div>}
      ...
      <button type="submit" className="btn-submit bg-blue-400 text-white p-2 rounded-md hover:bg-blue-500 hover:shadow-md transition-all">Create New Service</button>
    </form>
