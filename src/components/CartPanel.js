...
export default function CartPanel({ onClose }) {
  ...
  useEffect(() => {
    const guestCheckoutSessionId = localStorage.getItem(
      ...
      const pollInterval = setInterval(async () => {
        try {
          const response = await axios_api.get(
            `/check_payment_status/${guestCheckoutSessionId}`
          );
  ...
  const guestRenderForm = (
    <div className="login-form">
      <form onSubmit={handleGuestCheckoutDataSubmit}>
        ...
        <div
          className="registrationService-button-container"
          onClick={handleGuestCheckoutDataSubmit}
        >
                    ...
                    <div className="flex flex-col shadow-xl">
                      <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                        <div className="flex items-start justify-between">
                          <Dialog.Title className="text-lg font-medium text-white-900">
                            {typeCheckout === 0
                              ? "Felicitări!"
                              : "Atenționare!"}
                          </Dialog.Title>
                      ...
                      <div className="px-4 py-6 sm:px-6">
                        <p className="">
                          {" "}
                          {typeCheckout === 0
                            ? "Înregistrarea dumneavoastră a fost realizată cu succes! Verificați email-ul pentru mai multe detalii."
                            : "Momentan nu aveți nimic în coșul de cumpărături!"}
                        </p>
                      </div>
                    </div>
                    <div></div>
                      ...
                      <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                          ...
                                          <div>
                                            <div className="flex justify-between text-base font-medium text-gray-900">
                                              <div className="text-[0.8rem] text-gray-500">
                                                Număr participanți:{" "}
                                                {product.number_of_participants}
                                              </div>
                                              <p className="ml-4"></p>
                                            </div>
                                          </div>
                        ...
                        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                          ...
                          <p className="mt-0.5 text-sm text-gray-500">
                            Taxele sunt calculate la momentul achiziției.
                          </p>
                          <div className="mt-6">
                            <button
