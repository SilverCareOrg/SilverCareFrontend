...
const ArticleParagraph = () => {
  return (
    <div className=" flex items-center justify-center my-2">
      <div className="w-full flex items-center lg:max-w-[1450px] justify-center lg:justify-start md:px-14 ">
        <div className="flex flex-col justify-center items-center">
          <div className="flex flex-col lg:w-[950px] md:w-[750px] sm:w-[625px] sm:max-w-[1500px] max-w-[500px]">
            <img
              // style={{
              ...
              // }}
              className="cursor-pointer object-cover lg:w-[950px] lg:h-[407px] md:w-[750px] md:h-[320px] sm:w-[625px] sm:h-[267px] 
