...
const CheckoutDetails = () => {
  ...
  return (
    <>
      ...
      <div className="h-screen max-h-[60vh] flex items-center justify-center">
        <div className="max-w-lg w-full p-6">
          ...
          >
            ...
            <button
              type="submit"
              className="btn bg-indigo-600 text-white py-2 px-4 rounded-md hover:bg-indigo-700 focus:outline-none"
            >
              Submit Payment
            </button>
          </form>
