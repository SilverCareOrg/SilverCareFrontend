...
const CheckArticles = () => {
  return (
    <div className=" bg-light-purple mt-10 mb-20 h-48 flex items-center justify-center ">
      <div className="w-full flex items-center  justify-center flex-col lg:flex-row lg:justify-between md:px-28 max-w-[1450px]">
        <div className="flex flex-col items-center lg:items-start">
          ...
          <div className="text-sm pb-3 lg:pb-0 sm:text-lg md:text-xl tracking-[0.025em] leading-[24px] flex items-center max-w-[586px] shrink-0">
