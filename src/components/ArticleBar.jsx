    ...
    <div className=" bg-light-purple h-12 md:h-56 flex items-center justify-center">
      <div className="w-full flex items-center max-w-[1450px] justify-center flex-col lg:flex-row lg:justify-between md:px-28">
        <div className="flex flex-col items-center lg:items-start mb-2">
          <div className="flex-col mt-4 text-2xl sm:text-3xl md:text-4xl tracking-[0.05em]  font-semibold flex justify-center items-center h-10 shrink-0 ">
            Articole
          </div>
          <div className="text-sm hidden mt-4 md:flex text-center lg:text-left pb-3 lg:pb-0 sm:text-lg md:text-xl tracking-[0.05em] leading-[24px] items-center max-w-[900px] shrink-0">
