...
const PaymentCartPanel = ({ }) => {
  ...
  const ProgressBar = () => {
        return (
            <div className="self-stretch bg-light-purple h-[9rem] flex flex-col items-center justify-start text-center">
                <div className="flex-1 w-[77rem] flex flex-col items-center justify-center">
                    <div className="flex flex-row items-start justify-center">
                        <div className="flex flex-col items-center justify-center gap-[0.25rem]">
                            <div className="rounded-[5rem] bg-dark-navy w-[3.5rem] h-[3.5rem] flex flex-col items-center justify-center">
                        ...
                        <div className="self-stretch flex flex-row items-center justify-center pl-[0.5rem] pr-[0.5rem] relative mb-7">
                            <div className="box-border w-[25rem] z-[0] border-t-[2px] border-dashed border-white" />
                        </div>
                        <div className="flex flex-col items-center justify-center gap-[0.25rem]">
                            <div className="rounded-[5rem] bg-white w-[3.5rem] h-[3.5rem] flex flex-col items-center justify-center">
                ...
                {products.map((product, index) => (
                    ...
                    <div>
                        ...
                        <div className="flex-1 flex flex-col items-start justify-start py-[0rem] px-[1rem] gap-[0.1rem] w-full h-[13rem]">
                            ...
                            <div className="self-stretch flex flex-row items-start justify-start gap-[0.63rem]">
                                <div className="flex-1 relative tracking-[0.05em] leading-[1.5rem] font-medium flex items-center">
                                  {option.location != "" && <div className="self-stretch relative tracking-[0.05em] leading-[120%] text-text-fields-grey-hf font-medium  flex items-center shrink-0 text-[1rem]">Locație: <span className="ml-2 text-[1rem] font-open-sans font-normal">{option.location}</span></div>}
                                </div>
                            </div>
                            <div className="flex-1 flex flex-row items-end justify-end text-right">
                                <button className="relative tracking-[0.08em] leading-[120%]" onClick={() => handleRemoveButton(product.service_id, product.price)}>
                                    ȘTERGE
                                </button>
                            </div>
                        </div>
  ...
  return (
    <div>
    <div className="relative flex flex-col bg-white w-full overflow-hidden text-left text-[1rem] text-dark-navy font-text-body">
    <div className="relative w-full right-[0%] left-[0%] flex flex-col items-center justify-between">
        <ProgressBar />
        <div className="self-stretch flex flex-col items-center justify-start">
        <div className="w-[70rem] flex flex-row items-center justify-center">
            <div className="self-stretch flex-1 flex flex-col items-start justify-start pt-[1rem] px-[0rem] pb-[1.5rem] gap-[2.5rem]">
            <button className="self-stretch flex flex-row items-start justify-start gap-[1rem]" onClick={() => window.location.href = "/product"}>
                <img
                className="relative rounded-sm w-[0.83rem] h-[1.63rem]"
                alt=""
                src={back_icon_arrow}
                />
                <div className="relative tracking-[0.05em] leading-[1.5rem] font-medium flex items-center w-[50.56rem] h-[1.5rem] shrink-0">
                Continua cumparaturile
                </div>
            </button>
            <div className="self-stretch flex flex-col items-start justify-start gap-[1.5rem] text-text-fields-grey-hf">
                <ProductsList />
                <div className="self-stretch flex flex-row items-start justify-start gap-[0.5rem] text-dark-navy">
                  <div className="self-stretch relative tracking-[0.08em] leading-[120%] font-bold text-[1.2rem] flex items-center w-[34.75rem] shrink-0">
                    Total de plată: {price_total} RON
                  </div>
                </div>
                <div className="self-stretch flex flex-row items-start justify-start gap-[1.5rem] text-dark-navy">
                  <div className="w-[48.25rem] flex flex-row items-start justify-start gap-[0.5rem]">
                      <div className="flex items-start">
                        ...
                        />
                        <span
                        className="self-stretch tracking-[0.08em] leading-[120%] flex items-center w-[34.75rem] shrink-0 cursor-pointer"
                        >
                ...
                <div className="self-stretch flex flex-row items-start justify-start gap-[1.5rem] text-dark-navy">
                  <div className="w-[48.25rem] flex flex-row items-start justify-start gap-[1rem]">
                    <div className="flex items-start">
                      <input
                        type="checkbox"
